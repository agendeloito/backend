...
class UserListView(ListView):
    model = User
    template_name = "agendamiento/user_list.html"
    paginate_by = 20
...
class UserDetailView(DetailView):
    model = User
    template_name = "agendamiento/user_detail.html"
...
class UserCreateView(CreateView):
    ...
    template_name = "agendamiento/user_create.html"
    ...
    def get_success_url(self):
        return reverse("agendamiento:user_detail", args=(self.object.pk,))
...
class UserUpdateView(UpdateView):
    ...
    form_class = UserForm
    # fields = ['user', 'password', 'rol']
    template_name = "agendamiento/user_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class UserDeleteView(DeleteView):
    model = User
    template_name = "agendamiento/user_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "user"
    ...
    def get_success_url(self):
        return reverse("agendamiento:user_list")
